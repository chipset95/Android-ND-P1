package chipset.pone.resources;
...
public class Constants {
    ...
    public static final String URL_BACKDROP_IMAGE = "http://image.tmdb.org/t/p/w780";
    ...
    public static final String CONTENT_AUTHORITY = "chipset.pone.movies.provider";
}
